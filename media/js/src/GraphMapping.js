...
const exportGraph = function(state) {
    let obj = {
        ...
        a1_2: forceFloat(state.gA12),
        a1_max_2: forceFloat(state.gA1Max2),
        a1_min_2: forceFloat(state.gA1Min2),

        a2: forceFloat(state.gA2),
        a2_name: state.gA2Name,
        a2_max: forceFloat(state.gA2Max),
        a2_min: forceFloat(state.gA2Min),
        a2_2: forceFloat(state.gA22),
        a2_max_2: forceFloat(state.gA2Max2),
        a2_min_2: forceFloat(state.gA2Min2),

        a3: forceFloat(state.gA3),
        a3_name: state.gA3Name,
        a3_max: forceFloat(state.gA3Max),
        a3_min: forceFloat(state.gA3Min),
        a3_2: forceFloat(state.gA32),
        a3_max_2: forceFloat(state.gA3Max2),
        a3_min_2: forceFloat(state.gA3Min2),

        a4: forceFloat(state.gA4),
        a4_name: state.gA4Name,
        a4_max: forceFloat(state.gA4Max),
        a4_min: forceFloat(state.gA4Min),
        a4_2: forceFloat(state.gA42),
        a4_max_2: forceFloat(state.gA4Max2),
        a4_min_2: forceFloat(state.gA4Min2),

        a5: forceFloat(state.gA5),
        a5_name: state.gA5Name,
        a5_max: forceFloat(state.gA5Max),
        a5_min: forceFloat(state.gA5Min),
        a5_2: forceFloat(state.gA52),
        a5_max_2: forceFloat(state.gA5Max2),
        a5_min_2: forceFloat(state.gA5Min2),
        ...
        x_axis_max_2: forceFloat(state.gXAxisMax2),
        x_axis_min_2: forceFloat(state.gXAxisMin2),
        y_axis_max_2: forceFloat(state.gYAxisMax2),
        y_axis_min_2: forceFloat(state.gYAxisMin2),
...
const convertGraph = function(json) {
    return {
        ...
        gA12: forceFloat(json.a1_2),
        gA1Max2: forceFloat(json.a1_max_2),
        gA1Min2: forceFloat(json.a1_min_2),

        gA2: forceFloat(json.a2),
        gA2Name: json.a2_name,
        gA2Max: forceFloat(json.a2_max),
        gA2Min: forceFloat(json.a2_min),
        gA22: forceFloat(json.a2_2),
        gA2Max2: forceFloat(json.a2_max_2),
        gA2Min2: forceFloat(json.a2_min_2),

        gA3: forceFloat(json.a3),
        gA3Name: json.a3_name,
        gA3Max: forceFloat(json.a3_max),
        gA3Min: forceFloat(json.a3_min),
        gA32: forceFloat(json.a3_2),
        gA3Max2: forceFloat(json.a3_max_2),
        gA3Min2: forceFloat(json.a3_min_2),

        gA4: forceFloat(json.a4),
        gA4Name: json.a4_name,
        gA4Max: forceFloat(json.a4_max),
        gA4Min: forceFloat(json.a4_min),
        gA42: forceFloat(json.a4_2),
        gA4Max2: forceFloat(json.a4_max_2),
        gA4Min2: forceFloat(json.a4_min_2),

        gA5: forceFloat(json.a5),
        gA5Name: json.a5_name,
        gA5Max: forceFloat(json.a5_max),
        gA5Min: forceFloat(json.a5_min),
        gA52: forceFloat(json.a5_2),
        gA5Max2: forceFloat(json.a5_max_2),
        gA5Min2: forceFloat(json.a5_min_2),
        ...
        gXAxisMax2: forceFloat(json.x_axis_max_2),
        gXAxisMin2: forceFloat(json.x_axis_min_2),
        gYAxisMax2: forceFloat(json.y_axis_max_2),
        gYAxisMin2: forceFloat(json.y_axis_min_2),
