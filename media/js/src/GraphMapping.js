...
const exportGraph = function(state) {
    let obj = {
        ...
        a1_2_max: forceFloat(state.gA12Max),
        a1_2_min: forceFloat(state.gA12Min),
        a2_2: forceFloat(state.gA22),
        a2_2_max: forceFloat(state.gA22Max),
        a2_2_min: forceFloat(state.gA22Min),
        a3_2: forceFloat(state.gA32),
        a3_2_max: forceFloat(state.gA32Max),
        a3_2_min: forceFloat(state.gA32Min),
        a4_2: forceFloat(state.gA42),
        a4_2_max: forceFloat(state.gA42Max),
        a4_2_min: forceFloat(state.gA42Min),
        a5_2: forceFloat(state.gA52),
        a5_2_max: forceFloat(state.gA52Max),
        a5_2_min: forceFloat(state.gA52Min),
        ...
        x_axis_2_max: forceFloat(state.gXAxis2Max),
        x_axis_2_min: forceFloat(state.gXAxis2Min),
        y_axis_2_max: forceFloat(state.gYAxis2Max),
        y_axis_2_min: forceFloat(state.gYAxis2Min),
...
const convertGraph = function(json) {
    return {
        ...
        gA12Max: forceFloat(json.a1_2_max),
        gA12Min: forceFloat(json.a1_2_min),
        gA22: forceFloat(json.a2_2),
        gA22Max: forceFloat(json.a2_2_max),
        gA22Min: forceFloat(json.a2_2_min),
        gA32: forceFloat(json.a3_2),
        gA32Max: forceFloat(json.a3_2_max),
        gA32Min: forceFloat(json.a3_2_min),
        gA42: forceFloat(json.a4_2),
        gA42Max: forceFloat(json.a4_2_max),
        gA42Min: forceFloat(json.a4_2_min),
        gA52: forceFloat(json.a5_2),
        gA52Max: forceFloat(json.a5_2_max),
        gA52Min: forceFloat(json.a5_2_min),
        ...
        gXAxis2Max: forceFloat(json.x_axis_2_max),
        gXAxis2Min: forceFloat(json.x_axis_2_min),
        gYAxis2Max: forceFloat(json.y_axis_2_max),
        gYAxis2Min: forceFloat(json.y_axis_2_min),
