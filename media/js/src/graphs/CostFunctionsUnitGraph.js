...
export class CostFunctionsUnitGraph extends Graph {
    make() {
        const me = this;
...
export const mkCostFunctionsUnit = function(board, options) {
    let g = new CostFunctionsUnitGraph(board, options);
    g.make();
    g.postMake();
    return g;
};
