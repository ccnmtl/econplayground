...
function MonopolyFirstDegreePriceDiscriminationEditor(props) {
    const modesLeft = [
        'Outcome',
...
MonopolyFirstDegreePriceDiscriminationEditor.propTypes = {
...
export default MonopolyFirstDegreePriceDiscriminationEditor;
