...
class Graph(OrderedModel):
    ...
    x_axis_2_max = models.PositiveIntegerField(default=5)
    x_axis_2_min = models.PositiveIntegerField(default=0)
    y_axis_2_max = models.PositiveIntegerField(default=5)
    y_axis_2_min = models.PositiveIntegerField(default=0)
    ...
    a1_2 = models.DecimalField(
        max_digits=12, decimal_places=4, default=Decimal('0'))
    a1_2_max = models.IntegerField(default=10)
    a1_2_min = models.DecimalField(
        max_digits=12, decimal_places=4, default=Decimal('0'))
    a2_2 = models.DecimalField(
        max_digits=12, decimal_places=4, default=Decimal('0'))
    a2_2_max = models.IntegerField(default=10)
    a2_2_min = models.DecimalField(
        max_digits=12, decimal_places=4, default=Decimal('0'))
    a3_2 = models.DecimalField(
        max_digits=12, decimal_places=4, default=Decimal('0'))
    a3_2_max = models.IntegerField(default=10)
    a3_2_min = models.DecimalField(
        max_digits=12, decimal_places=4, default=Decimal('0'))
    a4_2 = models.DecimalField(
        max_digits=12, decimal_places=4, default=Decimal('0'))
    a4_2_max = models.IntegerField(default=10)
    a4_2_min = models.DecimalField(
        max_digits=12, decimal_places=4, default=Decimal('0'))
    a5_2 = models.DecimalField(
        max_digits=12, decimal_places=4, default=Decimal('0'))
    a5_2_max = models.IntegerField(default=10)
    a5_2_min = models.DecimalField(
        max_digits=12, decimal_places=4, default=Decimal('0'))
