...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0131_remove_jxglinetransformation_line_delete_jxgline_and_more'),
    ]
