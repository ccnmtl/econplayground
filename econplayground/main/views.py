            ...
            'graph_list': [
                {
                    ...
                    'image': '/img/linear_demand_supply.png',
                },
                {
                    'graph_type': 8,
                ...
                },
                {
                    ...
                    'image': '/img/linear_demand_supply_2.png',
                },
                {
                    'graph_type': 3,
                    'title': 'Cobb-Douglas Production Graph',
                    'image': '/img/cobb_douglas.png',
                },
                {
                    'graph_type': 1,
                    'title': 'Input Markets',
                    'image': '/img/non-linear_demand_supply.png',
                },
                {
                    'graph_type': 10,
                    'title': 'Input Markets: Areas',
                    'image': '/img/non-linear_demand_supply_area.png',
                },
                {
                    'graph_type': 14,
                ...
                },
                {
                    ...
                    'image': '/img/consumption_leisure.png',
                },
                {
                    'graph_type': 15,
                    'title': 'Consumption-Leisure: Optimal Choice',
                    'image': '/img/consumption_leisure_optimal.png',
                },
                {
                    'graph_type': 7,
                    'title': 'Consumption-Saving: Constraint',
                    'image': '/img/consumption_saving.png',
                },
                {
                    'graph_type': 11,
                    'title': 'Consumption-Saving: Optimal Choice',
                    'image': '/img/consumption_saving_optimal.png',
                },
                {
                    'graph_type': 16,
                    'title': 'Template Graph',
                    'image': '/img/template_graph.png',
                },
                {
                    'graph_type': 17,
                ...
                },
                {
                    ...
                    'image': '/img/cost_functions_total.png',
                },
                {
                    'graph_type': 19,
                ...
                },
                {
                    ...
                    'image': '/img/elasticity_demand_revenue.png',
                },
            ]
        })
        return ctx
