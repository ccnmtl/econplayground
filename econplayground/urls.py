...
urlpatterns = [
    ...
    path('question/',
         views.QuestionListView.as_view(), name='question_bank'),
    path('question/add/',
         views.QuestionCreateView.as_view(), name='question_create'),
    path('question/<int:pk>/',
         views.QuestionDetailView.as_view(), name='assignment_detail'),
    path('question/<int:pk>/edit/',
         views.QuestionUpdateView.as_view(), name='assignment_edit'),
